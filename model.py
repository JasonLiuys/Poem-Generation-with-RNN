...
class TrainModel(object):
    def __init__(self, data, labels, emb_keep, rnn_keep):  ##可添加春夏秋冬标签
        self.data = data  # 数据
    ...
    @define_scope
    def cell(self):
        lstm_cell = [ tf.nn.rnn_cell.DropoutWrapper(tf.nn.rnn_cell.BasicLSTMCell(HIDDEN_SIZE), output_keep_prob=self.rnn_keep) for _ in range(NUM_LAYERS)]
